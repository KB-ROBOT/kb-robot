...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinAccountController.do?doUpdate" tiptype="1">
		...
		<input id="addTokenTime" name="addTokenTime" type="hidden" value="${weixinAccountPage.addTokenTime }" />
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value">
					<input id="accountName" name="accountName" type="text" style="width: 150px" class="inputxt" value='${weixinAccountPage.accountName}'>
			...
			<tr>
				...
				<td class="value">
					<input id="accountToken" name="accountToken" type="text" style="width: 150px" class="inputxt" value='${weixinAccountPage.accountToken}'>
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="accountNumber" name="accountNumber" type="text" style="width: 150px" class="inputxt" value='${weixinAccountPage.accountNumber}'>
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="weixinAccountId" name="weixinAccountId" type="text" style="width: 150px" class="inputxt" value='${weixinAccountPage.weixinAccountId}'>
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="accountEmail" name="accountEmail" type="text" style="width: 150px" class="inputxt" value='${weixinAccountPage.accountEmail}'>
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="accountDesc" name="accountDesc" type="text" style="width: 150px" class="inputxt" value='${weixinAccountPage.accountDesc}'>
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="accountAppid" name="accountAppid" type="text" style="width: 150px" class="inputxt" value='${weixinAccountPage.accountAppid}'>
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="accountAppsecret" name="accountAppsecret" type="text" style="width: 150px" class="inputxt" value='${weixinAccountPage.accountAppsecret}'>
					<span class="Validform_checktip"></span>
