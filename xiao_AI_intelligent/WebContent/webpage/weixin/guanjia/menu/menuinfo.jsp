	...
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="menuManagerController.do?su" beforeSubmit="btnSubmit">
      ...
      <select name="fatherName" id="fatherName">
       ...
       -->
			...
			<tr>
				<td align="right" style="width: 65px">
					<label class="Validform_label"> 动作设置: </label>
				</td>
				<td colspan="3" class="value">
			...
			<tr id="trurl">
				<td align="right" style="width: 65px">
					<label class="Validform_label"> URL: </label>
				</td>
				<td colspan="3" class="value">
					<input id="url" class="inputxt" name="url" value="${url}" style="width: 300px">
					<!-- disabled="disabled"  地址不能编辑？？ 业务不了解。所以先注释掉 -->
			...
			<tr id="xxtr" style="width: 65px">
				...
				<td class="value" colspan="3">
					<input type="radio" value="text" name="msgType" id="msgType" datatype="*" <c:if test="${msgType=='text'}">checked="checked"</c:if> />文本 <input type="radio" value="news" name="msgType" <c:if test="${msgType=='news'}">checked="checked"</c:if> />图文 <input type="radio" value="expand" name="msgType" <c:if test="${msgType=='expand'}">checked="checked"</c:if> />扩展
			...
			<tr>
				<td align="right" style="width: 65px">
					<label class="Validform_label"> 菜单标识: </label>
				</td>
				<td class="value" colspan="3">
