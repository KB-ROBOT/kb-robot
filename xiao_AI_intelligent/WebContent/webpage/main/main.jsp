...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
					...
					<table>
						<tr>
							<td valign="top" height="50">
								<span style="color: #CC33FF">当前XX用户:</span>
								<span style="color: #666633"> (${userName }) </span>
								<span style="color: #CC33FF">当前微信账号:</span>
								<span style="color: #666633">${sessionScope.WEIXIN_ACCOUNT.accountName }</span>
								&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<td>
							...
							<div id="layout_north_kzmbMenu" style="width: 100px; display: none;">
								...
								<div class="menu-sep"></div>
								<div onclick="add('请选择微信账号','userController.do?changewexinaccount')">切换微信账号</div>
								<div class="menu-sep"></div>
	...
	<div id="mainPanle" region="center" style="overflow: hidden;">
		<div id="maintabs" class="easyui-tabs" fit="true" border="false">
			<div class="easyui-tab" title="首页：${map=='1'}${map}" href="loginController.do?home" style="padding: 2px; overflow: hidden;"></div>
			<c:if test="${map=='1'}">
	...
	<div collapsed="true" region="east" iconCls="icon-reload" title="辅助工具" split="true" style="width: 190px;" data-options="onCollapse:function(){easyPanelCollapase()},onExpand:function(){easyPanelExpand()}">
		...
		<div region="south" border="false" style="height: 25px; overflow: hidden;">
			<div align="center" style="color: #CC99FF; padding-top: 2px">
				&copy; 版权所有
				<span class="tip">
					<a href="http://www.jeewx.com" title="捷微 JeeWx：免费开源微信公众账号开发平台">捷微JeeWx</a>
					(推荐谷歌浏览器，获得更快响应速度) 技术支持:
					<a href="http://www.jeecg.org" title="JEECG开源社区">JEECG开源社区</a>
				</span>
			</div>
		</div>
