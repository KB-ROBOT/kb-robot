...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
							...
							<td style="" colspan="2">
								<div style="background: url(plug-in/login/images/top_bg.jpg) no-repeat right center; float: right;">
									<div style="float: left; line-height: 25px; margin-left: 70px;">
										<span style="color: #386780">当前SS用户:</span>
	...
	<div region="south" border="false" style="height: 25px; overflow: hidden;">
		<div align="center" style="color: #CC99FF; padding-top: 2px">
			&copy; 版权所有
			<span class="tip">
				<a href="http://www.jeewx.com" title="Jeewx 捷微管家系统" target="_blank">捷微官网</a>
				(推荐谷歌浏览器，获得更快响应速度) 技术支持:
				<a href="http://www.jeecg.org" title="Jeecg论坛" target="_blank"> Jeecg论坛</a>
			</span>
		</div>
	</div>
