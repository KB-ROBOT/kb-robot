		...
		<div class="navbar">
			<div class="navbar-inner">
				<div class="container-fluid">
					<a class="brand" href="http://www.jeecg.org" target="_blank">
						JEECG 演示系统 &nbsp;&nbsp;
					...
					<div class="nav-no-collapse bootstrap-menu">
						...
						<ul class="nav pull-right usernav">
							<li style="line-height: 43px;">
								<span style="color: #CC33FF">当前BB用户:</span>
								<span style="color: #666633">(${userName })</span>
								<span style="color: #386780">当前微信账号:</span>
								<span style="color: #FFFFFF">${sessionScope.WEIXIN_ACCOUNT.accountName }</span>
								&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li onclick="add('请选择微信账号','userController.do?changewexinaccount')">
										<a href="javascript:;">
											<i class="icon-retweet"></i> 切换微信账号
										</a>
									</li>
								</ul>
							</li>
		...
		<div class="container">
			<ul class="footer-links">
				...
				<li style="display: inline;">
					...
					<a title="JEECG Framework 3.4.3 GA版本" href="http://www.jeecg.org">JEECG Framework 3.4.3 GA</a>
				</li>
			</ul>
		</div>
	</footer>
