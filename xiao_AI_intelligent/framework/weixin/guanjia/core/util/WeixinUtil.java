...
public class WeixinUtil {
	...
	public static JSONObject httpsRequest(String requestUrl, String requestMethod, String outputStr) {
		...
		try {
			...
			if(url.getProtocol()==null||!url.getProtocol().equals("https")){
				throw new Exception("不是https或者不是有效的请求协议");
			}
	...
	public static JSONObject httpRequest(String requestUrl, String requestMethod, String outputStr){
		...
		try {
			...
			org.jeecgframework.core.util.LogUtil.info("server connection timed out.");
		}
		catch (Exception e) {
			org.jeecgframework.core.util.LogUtil.info("http request error:{}"+e.getMessage());
		}
		return jsonObject;
	}
